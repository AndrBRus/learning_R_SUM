...
# РАЗДЕЛ 3. Сохранение даннных
```{r save_data}
# сохраняем данные в файл
save(list = c(multiple_reg_model, var_struct_model, save_var_struct_model.corr, multiple_reg_model_log, var_struct_model_log, save_var_struct_model_log.corr, bondferroni_amend_model, bondferroni_amend_model_log, regions_data, regions_data_log, regions_data_load), file = 'lab2_VladimirovAA_data.RData')
```